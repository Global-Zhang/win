...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	public static String app_id = "自己注册";

	// 商户私钥，您的PKCS8格式RSA2私钥
	public static String merchant_private_key = "自己注册";
	// 支付宝公钥,查看地址：https://openhome.alipay.com/platform/keyManage.htm 对应APPID下的支付宝公钥。
	public static String alipay_public_key = "自己注册";
	// 服务器异步通知页面路径  需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	//添加内网穿透后，免费网址不一定时更换，注意检查
	public static String notify_url = "http://自己申请/win-portal/order/callback";
